...
difference() {
	union() {
		...
		*color("red")
		...
		// 2. Steg
		translate([support_distance_2-(support_width/2), 0, -pcb_thickness])
			cube([support_width, support_length, support_thickness]);
		
		// 3. Steg
		translate([pcb_length-support_width, 0, -pcb_thickness])
			cube([support_width, support_length, support_thickness]);
		
		// Rahmen unten
		translate([pcb_length/2, pcb_width/2, -pcb_thickness/2])
			difference() {
				cube([pcb_length+4*toleranz, pcb_width+2*toleranz, pcb_thickness], true);
				cube([pcb_length-2*strip_width, pcb_width-2*strip_width, pcb_thickness], true);
			}
...
translate([0, 0, -5]) {
	difference() {
		...
		// Aussparung Mutter
		translate([support_width/2, 3.5, -1])
			cylinder(h=3, r=mutter, center=true, $fn=6);
		// 1. Steg, 2. Loch
		translate([support_width/2, pcb_width-3.5, 0])
			cylinder(h=10, r=schraubenloch, center=true, $fn=48);
		// Aussparung Mutter
		translate([support_width/2, pcb_width-3.5, -1])
			cylinder(h=3, r=mutter, center=true, $fn=6);
		...
		translate([support_distance_2, 3.5, 0])
			cylinder(h=10, r=schraubenloch, center=true, $fn=48);
		// Aussparung Mutter
		translate([support_distance_2, 3.5, -1])
			cylinder(h=3, r=mutter, center=true, $fn=6);
		// 2. Steg, 2. Loch
		translate([support_distance_2, pcb_width-3.5, 0])
			cylinder(h=10, r=schraubenloch, center=true, $fn=48);
		// Aussparung Mutter
		translate([support_distance_2, pcb_width-3.5, -1])
			cylinder(h=3, r=mutter, center=true, $fn=6);
		...
		translate([support_distance_3, 3.5, 0])
			cylinder(h=10, r=schraubenloch, center=true, $fn=48);
		// Aussparung Mutter
		translate([support_distance_3, 3.5, -1])
			cylinder(h=3, r=mutter, center=true, $fn=6);
		// 3. Steg, 2. Loch
		translate([support_distance_3, pcb_width-3.5, 0])
			cylinder(h=10, r=schraubenloch, center=true, $fn=48);
		// Aussparung Mutter
		translate([support_distance_3, pcb_width-3.5, -1])
			cylinder(h=3, r=mutter, center=true, $fn=6);
